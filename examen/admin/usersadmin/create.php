...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    // zoek naar input errors voor het de database ingaat
    if(empty($username_err) && empty($password_err) && empty($email_err) && empty($telefoon_err) && empty($datum_err) && empty($geslacht_err)){
        ...
        if($stmt = mysqli_prepare($link, $sql)){
            ...
            // probeer de prepared statement te runnen
            if(mysqli_stmt_execute($stmt)){
                // Records succesfol gemaakt, redirect
